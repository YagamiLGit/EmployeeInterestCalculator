...
class FDaccount extends Account
{
	...
	double calculateInterest(double amount) throws InvalidAgeException,InvalidAmountException
...
class EmployeeInterestCalculator
{
	        ...
	        switch (choice) {
	            ...
	            case 2:
	                try {
	                    ...
	                    System.out.print("Interest gained is: $ " + fd.calculateInterest(fAmount));
		...
		break;
	            case 3:
	                try {
	                    ...
	                    System.out.print("Interest gained is: $ " + rd.calculateInterest(Ramount));
	                } catch (InvalidAgeException e) {
	                    System.out.println("Invalid Age Entered");
	                } catch (InvalidAmountException e) {
	                    System.out.println("Invalid Amount Entered");
